    ...
    >
        ...
        >
            ...
            <div class="overflow-y-auto" style="max-height: calc(100vh - 200px);">
                <div class="mt-4 mb-6">
                    <p class="mb-2 text-lg font-semibold text-gray-700">Migrar Estructura: {{ $tableName }}</p>

                    <form wire:submit.prevent="saveChanges">
                        <div class="grid grid-cols-2 gap-4">
                            <!-- Mostrar los campos de Oracle y los inputs para nuevos nombres -->
                            @foreach ($oracleFields as $index => $field)
                                <div class="flex items-center mb-2">
                                    <label class="w-full text-left">{{ $field->column_name }}</label>
                                    <input
                                        type="text"
                                        wire:model="newFields.{{ $index }}.new"
